...
while True:
    ...
    cv2.putText(display_frame, f"STATUS: ACTIVE | {now}", (20, 40),
    ...
    cv2.setWindowProperty(MAIN_WIN, cv2.WND_PROP_TOPMOST, 1)  # Force focus
